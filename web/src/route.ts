export type Tab = "live" | "usage" | "cache" | "quota" | "latency" | "requests" | "endpoints" | "models" | "providers" | "combos" | "settings";
export const TABS: Tab[] = ["live", "usage", "cache", "quota", "latency", "requests", "endpoints", "models", "providers", "combos", "settings"];
